...
CONFIG = {
    # --- User choices ---
    "cell_line": "HEPG2_new",     # options: "NIHOVCAR3", "U2OS",  "HEPG2_new"

    # Aggregation method
    "aggregation": "median",      # options: "mean", "median", None
    ...
    "split_files": {
        "structure": "Splitting_Smiles/structure_merge_st_vs_tk_thr0.65_smiles.npz",
        "stratified": "Splitting_Smiles/stratified_merge_st_vs_tk_smiles.npz"
    },
